...
write_cfgmem  -format mcs -size 256 -interface SPIx4 -loadbit $cfgmem_argc -checksum -force -disablebitswap -file "$flashmcs_path"
...
startgroup 
create_hw_bitstream -hw_device [lindex [get_hw_devices $hw_fpga] 0] [get_property PROGRAM.HW_CFGMEM_BITFILE [ lindex [get_hw_devices $hw_fpga] 0]]; program_hw_devices [lindex [get_hw_devices $hw_fpga] 0]; refresh_hw_device [lindex [get_hw_devices $hw_fpga] 0];
